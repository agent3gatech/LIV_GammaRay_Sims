...
//	TString  sInstrumentResponseFile = "/gpfs/pace1/project/phy-otte/agent3/LIV/IRFs/MAGIC.Mrk501.1.root";  //Old file with MigMatrix axes swapped
        TString  sInstrumentResponseFile = "/gpfs/pace1/project/phy-otte/agent3/LIV/IRFs/MAGIC.Mkn501.1.root";  //New file with correct axes for MigMatrix
