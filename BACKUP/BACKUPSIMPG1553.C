...
//=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\\
	...
	S->SetParameters(par);
        ...
        TF1 *BackgroundSpectrum = new TF1("BackgroundSpectrum","pow(x,-4.8)",0.4,0.8);
	TF1 *HadronSpectrum     = new TF1("HadronSpectrum"    ,"pow(x,-2.7)",0.4,0.8);
	...
	for(int i=0; i < totalIterations; i++) 
		{
 		 ...
 		 file << fixed << setprecision(6) << events[ind[i]] << "           " << fixed << setprecision(3) << recenergies[ind[i]] << "           "  << fixed << setprecision(3) << trueenergies[ind[i]] << "           " << fixed << setprecision(3) << effareas[ind[i]] << "           " << fixed << setprecision(3) << normareas[ind[i]] <<  "          " << flags[ind[i]] <<   "\n";
 		}
