...
//=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\/=\\
	...
	int meanIterations = 2462;              //Mean number of events, actual value randomly generated from Poissonian distribution. 
	...
	TH1D *h = new TH1D("h", "", 1225,    0, 3977);
        TH1D *a = new TH1D("a", "", 1225,    0.3, 4);
        TH1D *m = new TH1D("m", "", 1225,    0.3, 4);
	
        char name[16] = "testPKS2155.txt";
//      Distance      =  1.511e25;
