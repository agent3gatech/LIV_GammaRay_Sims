...
//=================================================================================================================================================
	...
	if (arrivaltime <= 1800)
		{
		EffArea           = hEffAreaTrue1->Interpolate(LogE);
	...
	if (arrivaltime > 1800 && arrivaltime <= 3600)
                {
		EffArea           = hEffAreaTrue2->Interpolate(LogE);
                NormalisedEffArea = EffArea/MaxEffArea;
	 ...
	 if (arrivaltime > 3600 && arrivaltime <= 5400)
                {
		EffArea           = hEffAreaTrue3->Interpolate(LogE);
                NormalisedEffArea = EffArea/MaxEffArea;
	...
	if (arrivaltime > 7200 && arrivaltime <= 9000)
                {
		EffArea           = hEffAreaTrue4->Interpolate(LogE);
                NormalisedEffArea = EffArea/MaxEffArea;
